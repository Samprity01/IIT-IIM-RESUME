...
\begin{center} \small anjalikumari625213@gmail.com, linkedin.com/in/anjali-kumari6252 - | Email: anjalikumari625213@gmail.com | Phone: +91-9708320363 \end{center}
...
\begin{itemize}[nosep]
    ...
    \resitem{Experience in API testing to satisfy the business logic and requirements using SwaggerUI and Postman.}
    \resitem{Deployed artifacts on PCF or VMbox using Linux commands and verified ELI logs on Splunk.}
    \resitem{Involved in writing and executing SQL queries to validate the backend data.}
    \resitem{\textbf{Technology/Platform:} Java, Parasoft SOA tool, Postman, SwaggerUI, RestAssured, Selenium Webdriver, BDD Framework, Maven, TestNG, Junit, Bamboo, Bitbucket, GIT.}
\end{itemize}
