...
\begin{itemize}[noitemsep]
    \resitem{C, C++, Java, Python, Data Analysis using Python}
\end{itemize}
\resheading{Operating Systems}
\begin{itemize}[noitemsep]
    \resitem{Windows, Linux, Android}
\end{itemize}
\resheading{Packages}
\begin{itemize}[noitemsep]
    \resitem{SCILAB, Pandas, scikit-learn, SciPy}
\end{itemize}
\resheading{DBMS}
\begin{itemize}[noitemsep]
    \resitem{Oracle, MySQL, SQLite}
\end{itemize}
\resheading{Areas of Interest}
\begin{itemize}[noitemsep]
    \resitem{Data Science, Machine Learning, Big Data Analytics, Algorithms}
\end{itemize}
