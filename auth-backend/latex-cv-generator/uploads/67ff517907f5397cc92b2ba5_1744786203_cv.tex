...
\begin{itemize}[nosep]
    \resitem{Bachelor of Engineering (BE) in Computer Science Engineering (2017)}
    \resitem{Birla Institute of Technology, Mesra [CGPA - 7.63 with Distinction]}
    \resitem{Senior Secondary, XIIth (2013)}
    \resitem{State Board [Percentage – 74.8\%]}
    \resitem{Secondary, Xth (2011)}
    \resitem{State Board [Percentage – 83.2\%]}
\end{itemize}
